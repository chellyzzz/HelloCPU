...
wire valid_ins = type_i || type_i_load || type_r || type_lui || type_auipc ||
                 type_jal || type_jalr || type_s || type_b || type_ebrk || type_cop || type_vsetivli || type_vaddvv || type_vaddvx || type_vbitvv ||
                 (opcode == TYPE_FENCE);

wire [4:0] sidecar_rs1_addr = (type_auipc || type_lui || type_jal || type_vaddvv || type_vbitvv) ? 5'b0 : rs1;
wire [4:0] sidecar_rs2_addr = (type_r || type_b || type_s || type_cop) ? rs2 : 5'b0;
wire sidecar_wen = valid_ins && !(type_s || type_b || opcode == TYPE_FENCE || type_vaddvv || type_vaddvx || type_vbitvv);
...
assign o_predecode_bundle = {
    ...
    sidecar_fence_i,
    type_m,
    type_cop || type_vsetivli || type_vaddvv || type_vaddvx || type_vbitvv,
    sidecar_ecall,
    sidecar_mret,
    sidecar_ebreak
};
