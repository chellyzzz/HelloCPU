...
wire valid_ins = type_i || type_i_load || type_r || type_lui || type_auipc ||
                 ...
                 type_vsubvv || type_vsubvx || type_vmulvv || type_vmulvx || type_vshiftvv || type_vshiftvx || type_vmvvv || type_vmvvx ||
...
wire [4:0] sidecar_rs1_addr = (type_auipc || type_lui || type_jal || type_vaddvv || type_vaddvi ||
                               type_vbitvv || type_vbitvi || type_vsubvv || type_vmulvv || type_vshiftvv || type_vmvvv) ? 5'b0 : rs1;
...
wire sidecar_wen = valid_ins && !(type_s || type_b || opcode == TYPE_FENCE || type_vaddvv || type_vaddvx ||
                                  ...
                                  type_vbitvi || type_vsubvv || type_vsubvx || type_vmulvv || type_vmulvx || type_vshiftvv || type_vshiftvx ||
                                  type_vle8v || type_vse8v || type_vle16v || type_vse16v || type_vle32v || type_vse32v);
...
assign o_predecode_bundle = {
    ...
    type_vbitvi || type_vsubvv || type_vsubvx || type_vmulvv || type_vmulvx || type_vshiftvv || type_vshiftvx || type_vmvvv || type_vmvvx ||
    type_vle8v || type_vse8v || type_vle16v || type_vse16v || type_vle32v || type_vse32v,
    sidecar_ecall,
    sidecar_mret,
    sidecar_ebreak
