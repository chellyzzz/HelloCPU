...
wire type_vredsumvs = (opcode == TYPE_OPV) && (func3 == 3'b010) && (i_ins[31:26] == 6'b000000);
...
wire type_vmulvv = (opcode == TYPE_OPV) && (func3 == 3'b010) && (i_ins[31:26] == 6'b100101);
wire type_vmulvx = (opcode == TYPE_OPV) && (func3 == 3'b110) && (i_ins[31:26] == 6'b100101);
wire type_vcmpvv = (opcode == TYPE_OPV) && (func3 == 3'b000) &&
                   ((i_ins[31:26] == 6'b011000) || (i_ins[31:26] == 6'b011001) ||
                    (i_ins[31:26] == 6'b011010) || (i_ins[31:26] == 6'b011011));
wire type_vcmpvx = (opcode == TYPE_OPV) && (func3 == 3'b100) &&
                   ((i_ins[31:26] == 6'b011000) || (i_ins[31:26] == 6'b011001) ||
                    (i_ins[31:26] == 6'b011010) || (i_ins[31:26] == 6'b011011));
...
wire type_vshiftvx = (opcode == TYPE_OPV) && (func3 == 3'b100) &&
                     ((i_ins[31:26] == 6'b100101) || (i_ins[31:26] == 6'b101000) || (i_ins[31:26] == 6'b101001));
wire type_vmergevv = (opcode == TYPE_OPV) && (func3 == 3'b000) && (i_ins[31:26] == 6'b010111) && (i_ins[25] == 1'b0);
wire type_vmergevx = (opcode == TYPE_OPV) && (func3 == 3'b100) && (i_ins[31:26] == 6'b010111) && (i_ins[25] == 1'b0);
...
wire type_vle16v = (opcode == TYPE_VLOAD) && (func3 == 3'b101) && (i_ins[31:20] == 12'b000000100000);
wire type_vse16v = (opcode == TYPE_VSTORE) && (func3 == 3'b101) && (i_ins[31:25] == 7'b0000001) && (i_ins[24:20] == 5'b00000);
...
wire valid_ins = type_i || type_i_load || type_r || type_lui || type_auipc ||
                 ...
                 type_vredsumvs || type_vsubvv || type_vsubvx || type_vmulvv || type_vmulvx || type_vcmpvv || type_vcmpvx ||
                 type_vshiftvv || type_vshiftvx || type_vmergevv || type_vmergevx || type_vmvvv || type_vmvvx ||
                 type_vle8v || type_vse8v || type_vle16v || type_vse16v || type_vle32v || type_vse32v ||
                 (opcode == TYPE_FENCE);

wire [4:0] sidecar_rs1_addr = (type_auipc || type_lui || type_jal || type_vaddvv || type_vaddvi ||
                               type_vbitvv || type_vbitvi || type_vsubvv || type_vmulvv || type_vcmpvv || type_vredsumvs || type_vshiftvv || type_vmergevv || type_vmvvv) ? 5'b0 : rs1;
...
wire sidecar_wen = valid_ins && !(type_s || type_b || opcode == TYPE_FENCE || type_vaddvv || type_vaddvx ||
                                  ...
                                  type_vbitvi || type_vsubvv || type_vsubvx || type_vmulvv || type_vmulvx || type_vcmpvv || type_vcmpvx || type_vredsumvs ||
                                  type_vshiftvv || type_vshiftvx || type_vmergevv || type_vmergevx ||
                                  type_vle8v || type_vse8v || type_vle16v || type_vse16v || type_vle32v || type_vse32v);
