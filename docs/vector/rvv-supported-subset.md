...
| 指令 | 当前状态 | 第一批 RVV 目标 | 备注 |
|------|----------|-----------------|------|
| `vmv.v.v` | prototype | planned | 可作为 VRF move/copy 基础 |
| `vmv.v.x` | prototype | planned | 可作为 scalar-to-vector splat 或受限 move |
...
| `vse32.v` | prototype | planned | store kill/commit 语义需先收敛 |
